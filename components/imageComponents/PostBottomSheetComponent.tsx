...
const PostBottomSheetComponent: React.FC<Props> = ({
  ...
  if (isSelectingGym) {
    return (
      <TagGymComponent
        setIsSelectingGym={setIsSelectingGym}
  ...
  if (isSelectingGrade && selectedGym !== undefined) {
    return (
      <PickGradeComponent
        setIsSelectingGrade={setIsSelectingGrade}
        setSelectedGrade={setSelectedGrade}
        gymGrades={selectedGym.gym_grade}
      />
    );
  }
    ...
    <View style={styles.container}>
      <View style={styles.titleContainer}>
        <List.Item
          title="Tag Gyms"
          description={
            selectedGym === undefined ? "No gym selected" : selectedGym.name
          }
        ...
        {selectedGym && (
          <List.Item
            title="Select grade"
            description={
              selectedGrade === null ? "Select a grade" : selectedGrade
            }
            right={(props) => <List.Icon {...props} icon="arrow-right" />}
